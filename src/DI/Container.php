 ...
 */
class Container implements ReadableContainerInterface
{
    /**
     ...
     * @param ReadableContainerInterface    $wrapperContainer  If the container is wrapped by another container.
     */
